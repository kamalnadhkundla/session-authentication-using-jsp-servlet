...
<head>
    ...
    <script>
         ...
         function checkPassword(form){
        	 ...
        	 alert("your sport is confirmed and please pay at the reception ");
         }        
     
    </script>
    <link rel ="stylesheet" href="style1.css">
<body>
    <form class=box1 onSubmit = "return checkPassword(this)" action="booksport" method="POST">
        <h1>BOOK NOW</h1>
        ...
        <input type ="text" name="datee" placeholder="enter  date">
